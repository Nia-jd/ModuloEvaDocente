        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div class="flex flex-wrap -mx-3 mb-6 ">
            <div class="w-full  px-2 mb-6 md:mb-0 md:flex md:items-center md:w-1/5">
              ...
              <input class="bg-gray-200 appearance-none border-2 border-gray-200 w-full rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="fecha-inicio" type="text" placeholder=""></input>
            </div>
            <div class="w-full px-3 mb-6 md:mb-0 md:flex md:items-center md:w-1/6">
              ...
              <input class="bg-gray-200 appearance-none border-2 border-gray-200 w-full rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="hora-inicio" type="text" placeholder=""></input>
            </div>
            <div class="w-full px-2 mb-6 md:mb-0 md:flex md:items-center md:w-1/4">
              ...
              <input class="bg-gray-200 appearance-none border-2 border-gray-200 w-full rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="fecha-final" type="text" placeholder=""></input>
            </div>
            <div class="w-full px-3 mb-6 md:mb-0 md:flex md:items-center md:w-1/6">
              <label class="block text-gray-500 mb-1 md:mb-0" for="hora-final">
                Hora Final
              </label>
              <input class="bg-gray-200 appearance-none border-2 border-gray-200 w-full rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="hora-final" type="text" placeholder=""></input>
            </div>
            <div class="w-full px-2 mb-6 md:mb-0 md:flex md:items-center md:w-1/5">
              <label class="block text-gray-500 mb-1 md:mb-0" for="periodo">
                Periodo
              </label>
              <div class="static">
          ...
          <div>
            <div className=''>
              <button className='bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-full' onClick={() => setOpen(true)}>
                Agregar
              </button>
            </div>
            <img src='img/eliminar.png' title='eliminar' id='eliminar' name='eliminar' alt='eliminar'></img>
            <div className={`${!open && "hidden"}  w-full fixed top-0 left-0 right-0 backdrop-blur-sm`} onClick={() => setOpen(false)}></div>

            <div className={`${open ? "w-80" : "w-0"} fixed transition-all duration-300`}>
